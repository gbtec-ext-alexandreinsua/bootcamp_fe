...
async function main() {
    ...
    const p = "My name is ";
    const h1 = resultado.results[0].name.title + " " + resultado.results[0].name.first + " " + resultado.results[0].name.last;
    const h2 = resultado.results[0].location.city + " " + resultado.results[0].location.street.name + " " + resultado.results[0].location.street.number;
    const h3 = resultado.results[0].phone + " " + resultado.results[0].email;
