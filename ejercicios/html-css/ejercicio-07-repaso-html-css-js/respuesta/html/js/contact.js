document.addEventListener("DOMContentLoaded", () => {
  ...
  const formElements = `
    ...
    <div id="name-error" class="error-message" style="display: none; color: red;">Name is required</div>

    <label for="email">Email*:</label>
    <input type="email" id="email" name="email" placeholder="Your Mail Address" required />
    <div id="email-error" class="error-message" style="display: none; color: red;">A valid email is required</div>

    <label for="subject">Subject*:</label>
    <input type="text" id="subject" name="subject" placeholder="Reason For Contacting" required />
    <div id="subject-error" class="error-message" style="display: none; color: red;">Subject is required</div>
